...
public class ContainerElementGenerator extends ContainerMachine {
	...
	public ContainerElementGenerator(InventoryPlayer par1InventoryPlayer, TileEntityElementGenerator tileEntity) {
